    ...
    return (
        <section
            ...
            <div className="max-w-3xl mx-auto px-4">
                <h2 className="text-3xl font-bold mb-8 bg-gradient-to-r from-lime-600 via-yellow-500 to-purple-700 bg-clip-text text-center text-transparent ">{""} About Me </h2>
